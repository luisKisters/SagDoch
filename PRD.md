...
- **Visual Reference:** Figma `node-id=2-2`
...
- **Visual References:**
  - Empty input: Figma `node-id=8-30`
  - Name input filled: Figma `node-id=28-277`
  - Multiple players & start: Figma `node-id=41-358`
- **UI Elements (German Text & Lucide Icons):**
  ...
  - **Gender Selection Modal/Step (conditionally rendered):**
    - Visual Ref: Figma `node-id=29-361`
  ...
  - **Sexuality Selection Modal/Step (conditionally rendered):**
    - Visual Ref: Figma `node-id=29-509`
...
- **Visual References:**
  ...
  - Truth/Dare choice: Figma `node-id=41-612`
- **UI Elements (German Text):**
...
- **Visual References:**
  - Truth: Figma `node-id=51-681`
  - Dare: Figma `node-id=54-700`
- **UI Elements (German Text):**
  - **Top Red Area:**
